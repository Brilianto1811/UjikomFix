...
@section('subcontent')
    <h2 class="intro-y mt-5 text-lg font-medium text-center py-2 bg-primary"
        ...
        LIST PENDAFTARAN MAHASISWA
    </h2>
    <div class="col-span-12 mt-8">
        <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center sm:flex-nowrap">
            <x-base.button as="a" href="{{ route('pendaftaranmahasiswa.create') }}" class="mr-2 shadow-md"
                variant="primary">
                Tambah
            </x-base.button>
                                            ...
                                            <x-base.table.td class="whitespace-nowrap">
                                                <div class="flex items-center justify-center">
                                                    <a class="mr-3 flex items-center text-warning"
                                                        href="{{ route('pendaftaranmahasiswa.edit', ['id_akun' => $data['id_akun']]) }}">
                                                        <x-base.lucide class="mr-1 h-4 w-4" icon="pencil-line" />
                                                        EDIT
                                                    </a>
                                                    <a class="mr-3 flex items-center text-primary"
                                                        href="{{ route('pendaftaranmahasiswa.detail', ['id_akun' => $data['id_akun']]) }}">
            ...
            <div data-tw-merge
                ...
                <div class="px-5 pb-8 text-center flex justify-center space-x-2">
                    ...
                    <x-base.button as="a" data-tw-merge
                        href="{{ route('pendaftaranmahasiswa.proses-delete', ['id' => $data->id_akun]) }}"
